...
def compute_score(solution_str, ground_truth, method="strict", bool_result_score=0.4, bool_format_score=0.2, reflection_score=0.1, format_score=0.0, score=1.0):
        ...
        if em_check(answer, ground_truth["target"]):
            if has_reflection:
                if bool_result == 'true':
                    ...
                    return score - bool_result_score
                else:
                    return score - bool_result_score - bool_format_score
            else:
                if bool_result == 'true':
                    return score - reflection_score
                elif bool_result == 'false':
                    return score - bool_result_score - reflection_score
                else:
                    return score - reflection_score - bool_format_score
        else:
            if has_reflection:
                if bool_result == 'true':
                    return reflection_score
                elif bool_result == 'false':
                    return bool_result_score + reflection_score
                else:
                    return reflection_score - bool_format_score
            else:
                if bool_result == 'true':
                    return 0
                elif bool_result == 'false':
                    return bool_result_score
                else:
                    return 0


def compute_score_subem(solution_str, ground_truth, method="strict", bool_result_score=0.4, bool_format_score=0.0, reflection_score=0.1, format_score=0.0, score=1.0):
    """The scoring function for exact match (EM).
        ...
        if subem_check(answer, ground_truth["target"]):
            if has_reflection:
                if bool_result == 'true':
                    ...
                    return score - bool_format_score
            else:
                if bool_result == 'true':
                    return score - reflection_score
                elif bool_result == 'false':
